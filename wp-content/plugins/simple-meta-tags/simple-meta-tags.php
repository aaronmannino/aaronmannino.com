...
if (!class_exists("sc_simple_meta_tags")) {
	...
	function sc_create_wonder_form(){
		...
		<input type="text" size="100" id="scmetadescription" name="scmetadescription" value="<?php echo get_post_meta($post->ID, '_sc_m_description', true); ?>" /><br /><br />
		
		<b>Meta Keywords</b><br />
		<input type="text" size="100" id="scmetakeywords" name="scmetakeywords" value="<?php echo get_post_meta($post->ID, '_sc_m_keywords', true); ?>" /><br /><br />
		<?php
	}
